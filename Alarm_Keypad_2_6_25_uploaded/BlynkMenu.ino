...
if (strlen(cmd_str) == 1){
  ...
  /*
  if (strcmp(cmd_str, "1") == 0) {terminalKeyPress(1); return;} // virtual keypad ?123456789*0#<>sacbed
  if (strcmp(cmd_str, "2") == 0) {terminalKeyPress(2); return;}
  if (strcmp(cmd_str, "3") == 0) {terminalKeyPress(3); return;}
  if (strcmp(cmd_str, "4") == 0) {terminalKeyPress(4); return;}
  if (strcmp(cmd_str, "5") == 0) {terminalKeyPress(5); return;}
  if (strcmp(cmd_str, "6") == 0) {terminalKeyPress(6); return;}
  if (strcmp(cmd_str, "7") == 0) {terminalKeyPress(7); return;} 
  if (strcmp(cmd_str, "8") == 0) {terminalKeyPress(8); return;}
  if (strcmp(cmd_str, "9") == 0) {terminalKeyPress(9); return;}
  if (strcmp(cmd_str, "*") == 0) {terminalKeyPress(10); return;}
  if (strcmp(cmd_str, "0") == 0) {terminalKeyPress(11); return;}
  if (strcmp(cmd_str, "#") == 0) {terminalKeyPress(12); return;}
  if (strcmp(cmd_str, "<") == 0) {terminalKeyPress(13); return;}
  if (strcmp(cmd_str, ">") == 0) {terminalKeyPress(14); return;}
  if (strcmp(cmd_str, "s") == 0) {terminalKeyPress(15); return;}  // stay
  if (strcmp(cmd_str, "a") == 0) {terminalKeyPress(16); return;}  // away
  if (strcmp(cmd_str, "c") == 0) {terminalKeyPress(17); return;}  // chime
  if (strcmp(cmd_str, "b") == 0) {terminalKeyPress(18); return;}  // bypass
  if (strcmp(cmd_str, "e") == 0) {terminalKeyPress(19); return;}  // exit
  // for disarm, change cmd_str to a multikey keypad terminal 
  //   input " x x x x" with masterCode to be executed below
  */
  ...
  if (strcmp(cmd_str, "d") == 0) { // disarm - make new cmd_str for virtual multikey
    ...
    cmd_length_int = strlen(cmd_str);  // update cmd_str length - does not include '\0'.
    } // no return here so drop down to virtual multikey with new command
  
  if (cmd_str[0] == ' '){  // virtual miltikey keypad " xxxx..."
    for (int i = 1; i < cmd_length_int; i++){ // skip first space as control char
      char *e;
